    ...
    try:
        response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": f"You are an expert {specialty} conducting honest self-reflection about different reasoning approaches. You write in a thoughtful, analytical style that demonstrates both self-awareness and domain expertise.",
                },
